...
class SubscriptionBloc {
  ...
  final StreamController<String> _typeChangeController =
      StreamController<String>();
  Sink<String> get typeChange => _typeChangeController.sink;

  final BehaviorSubject<String> _type =
      BehaviorSubject<String>(seedValue: 'TitleItem');
  Stream<String> get typeString => _type.stream;

  final BehaviorSubject<bool> _showSelectField =
  ...
  final BehaviorSubject<String> _content =
  ...
  Future<bool> subscriptionSave() async {
    final SubscriptionItem subItem =
        SubscriptionItem(content: content, type: type);
